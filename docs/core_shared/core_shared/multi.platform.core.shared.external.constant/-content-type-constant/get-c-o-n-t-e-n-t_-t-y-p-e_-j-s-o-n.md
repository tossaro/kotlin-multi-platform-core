//[core_shared](../../../index.md)/[multi.platform.core.shared.external.constant](../index.md)/[ContentTypeConstant](index.md)/[getCONTENT_TYPE_JSON](get-c-o-n-t-e-n-t_-t-y-p-e_-j-s-o-n.md)
